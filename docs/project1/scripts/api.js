        ...
        <tr>
            ...
            <td class="actions">
                <div class="icons-wrapper">
                    ...
                    <img class="icon-edit" src="../images/icons/edit.png" alt="edit button" onclick="editPatientForms(${id})">
...
function patientForm (id, cpf, name, birthday, email, gender, nationality, placeOfBirth, job, education, maritalStatus, mother, father) {
    const patientForm = `
        <div class="fields">
            <div class="form-field roboto-form-16">
                <label class="label" for="cpf">CPF</label>
                <input class="input" type="text" name="cpf" id="cpf" value="${cpf}" >
            </div>
            <div class="form-field roboto-form-16">
            ...
            <div class="form-field roboto-form-16">
                ...
                <input class="input" type="text" name="birthday" id="birthday" value="${birthday}" >
            </div>
        </div>
        <div class="fields">
            <div class="form-field roboto-form-16">
            ...
            <div class="form-field roboto-form-16">
                ...
                <select class="input select" name="nationality" id="nationality"  value="${nationality}">
                    <option value="" disabled>Escolha</option>
...
// const putPost = async (id = '', post, method) => {
...
const patientData = async (id) => {
    ...
    showPatient.innerHTML += patientForm (patient.id, patient.cpf, patient.name, patient.birthday, patient.email, patient.gender, patient.nationality, patient.placeOfBirth, patient.job, patient.education, patient.maritalStatus, patient.mother, patient.father)
    ...
    showPatient.querySelector('.icon-edit').addEventListener('click', function() {
        showPatient.classList.add('none')
...
const editPatient = async (id) => {
    ...
    // document.querySelector('#nationality').value = patient.nationality
    // document.querySelector('#marital-status').value = patient.maritalStatus
    const patientformElement = document.createRange().createContextualFragment(patientForm(patient.id, patient.cpf, patient.name, patient.birthday, patient.email, patient.gender, patient.nationality, patient.placeOfBirth, patient.job, patient.education, patient.maritalStatus, patient.mother, patient.father))
